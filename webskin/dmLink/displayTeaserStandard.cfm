...
<cfset trackLink = replaceList(stObj.link,".,http://","_,") />
...
<cfoutput>
	...
	<cfif trim(len(stObj.teaser))>
		<p>
		#stObj.teaser#
		<a href="#stObj.link#" target="_new" class="morelink"  onClick="javascript: pageTracker._trackPageview('/external/#trackLink#');">Go<span>about:#stObj.Title#</span></a>
		</p>
	</cfif>
</cfoutput>
