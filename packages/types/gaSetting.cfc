<cfcomponent displayname="Google Analytics configuration" hint="Configuration for Google Analytics" extends="farcry.core.packages.types.types" output="false" bObjectBroker="1">
	...
	<cfproperty ftSeq="23" ftFieldset="Google Analytics API Access" name="googleRefreshToken" type="string" ftLabel="Refresh Token" ftWatch="googleClientID,googleClientSecret,googleProxy" ftHint="This is obtained from Google after you give UNSW TV authorisation to access Google Analytics, and is used for ongoing API access." />
